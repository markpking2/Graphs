...
`add_friendship()` would need to be called 500 times.  The number of times is approximately `(num_users * avg_friendships) / 2`. This is because each time `add_friendship()` is called, a friendship is added to 2 users. `500 calls * 2 = 1000 friends`, `1000 friends/100 users = 10 average friends between users`.

2. If you create 1000 users with an average of 5 random friends each, what percentage of other users will be in a particular user's extended social network? What is the average degree of separation between a user and those in his/her extended network?
Approximately 99% of other uses will be in a particular user's extended social network.  The average degree of speculation is approximately 5.
